...
export default {
  ...
  methods:{
    ...
    getCurrentList: function(){
      let axiosUrl = "http://localhost:9527/get_current_list"
      let self=this
      axios.get(axiosUrl)
    ...
    getShowAll:function(){
       let axiosUrl = "http://localhost:9527/get_show_all"
      let self=this
      axios.get(axiosUrl)
        .then(function(response){
          setTimeout(() =>{
    ...
    characterClick:function(data){
      ...
      let axiosUrl = "http://localhost:9527/update_current_list"
      axios.post(axiosUrl,{
          id:id,
    ...
    startGame:function(){
      self = this
      axios.get('http://localhost:9527/start_game',{
      })
      .then(function(response){
        ...
        self.show_all = false
        let axiosUrl = "http://localhost:9527/update_show_all"
        axios.post(axiosUrl,{
            show_all:"false",
        })
        .then(function(response){
    ...
    resetGame:function(){
      let axiosUrl = "http://localhost:9527/reset_game"
      let self=this
      axios.get(axiosUrl)
        .then(function(response){})
      .catch(function(error){
